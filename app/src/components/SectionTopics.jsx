...
function CustomTooltip({ active, payload }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ color: 'var(--female)' }}>
        Female-presenting: {d.female} ({d.femalePct.toFixed(1)}%)
      </div>
      <div style={{ color: 'var(--male)' }}>
        Male-presenting: {d.male} ({d.malePct.toFixed(1)}%)
      </div>
      <div style={{ color: 'var(--unclassified)' }}>
        Unclassified: {d.unclassified} ({d.unclassifiedPct.toFixed(1)}%)
      </div>
      ...
      <div style={{ overflowY: 'auto' }}>
        <ResponsiveContainer width="100%" height={chartHeight}>
          ...
          >
            ...
            <Bar
              dataKey="unclassifiedPct"
              stackId="a"
              fill="var(--unclassified)"
              name="Unclassified"
            />
          </BarChart>
        </ResponsiveContainer>
